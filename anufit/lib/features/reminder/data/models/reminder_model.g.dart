...
const ReminderModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'repeat': PropertySchema(id: 5, name: r'repeat', type: IsarType.string),
...
extension ReminderModelQueryFilter
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterFilterCondition> hourEqualTo(
    int value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterFilterCondition> hourBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterFilterCondition>
  repeatEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'repeat',
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterFilterCondition>
  repeatStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.startsWith(
          property: r'repeat',
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterFilterCondition>
  repeatEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.endsWith(
          property: r'repeat',
  ...
  repeatIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'repeat', value: ''),
      );
    });
  }
  ...
  repeatIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'repeat', value: ''),
      );
    });
  }
...
extension ReminderModelQuerySortBy
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> sortByEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'enabled', Sort.asc);
    });
  }

  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> sortByEnabledDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'enabled', Sort.desc);
    });
  }

  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> sortByHour() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hour', Sort.asc);
    });
  }

  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> sortByHourDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hour', Sort.desc);
    });
  }

  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> sortByMinute() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'minute', Sort.asc);
    });
  }

  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> sortByMinuteDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> sortByRepeat() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'repeat', Sort.asc);
    });
  }

  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> sortByRepeatDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ReminderModelQuerySortThenBy
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> thenByEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'enabled', Sort.asc);
    });
  }
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> thenByHour() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hour', Sort.asc);
    });
  }

  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> thenByHourDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hour', Sort.desc);
    });
  }
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> thenByMinute() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'minute', Sort.asc);
    });
  }

  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> thenByMinuteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'minute', Sort.desc);
    });
  }
  ...
  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> thenByRepeat() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'repeat', Sort.asc);
    });
  }

  QueryBuilder<ReminderModel, ReminderModel, QAfterSortBy> thenByRepeatDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'repeat', Sort.desc);
    });
  }
...
extension ReminderModelQueryWhereDistinct
  ...
  QueryBuilder<ReminderModel, ReminderModel, QDistinct> distinctByHour() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'hour');
    });
  }

  QueryBuilder<ReminderModel, ReminderModel, QDistinct> distinctByMinute() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReminderModel, ReminderModel, QDistinct> distinctByRepeat({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ReminderModelQueryProperty
  ...
  QueryBuilder<ReminderModel, int, QQueryOperations> hourProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'hour');
    });
  }

  QueryBuilder<ReminderModel, int, QQueryOperations> minuteProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'minute');
    });
  }

  QueryBuilder<ReminderModel, int, QQueryOperations> notificationIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'notificationId');
    });
  }

  QueryBuilder<ReminderModel, String, QQueryOperations> repeatProperty() {
    return QueryBuilder.apply(this, (query) {
