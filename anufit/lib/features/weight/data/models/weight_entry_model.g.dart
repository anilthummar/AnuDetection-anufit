...
extension WeightEntryModelQueryWhereSort
  ...
  QueryBuilder<WeightEntryModel, WeightEntryModel, QAfterWhere> anyDate() {
    return QueryBuilder.apply(this, (query) {
...
extension WeightEntryModelQuerySortBy
  ...
  QueryBuilder<WeightEntryModel, WeightEntryModel, QAfterSortBy> sortByDate() {
    return QueryBuilder.apply(this, (query) {
...
extension WeightEntryModelQuerySortThenBy
  ...
  QueryBuilder<WeightEntryModel, WeightEntryModel, QAfterSortBy> thenByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }
...
extension WeightEntryModelQueryWhereDistinct
  ...
  QueryBuilder<WeightEntryModel, WeightEntryModel, QDistinct> distinctByDate() {
    return QueryBuilder.apply(this, (query) {
...
extension WeightEntryModelQueryProperty
  ...
  QueryBuilder<WeightEntryModel, DateTime, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
